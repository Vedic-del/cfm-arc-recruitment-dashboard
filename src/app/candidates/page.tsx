    ...
    <div className="animate-fade-in-up">
      ...
      {candidates.length === 0 ? (
        <div className="animate-fade-in-up rounded-xl border border-dashed border-slate-300 bg-white p-12 text-center">
          ...
          <h2 className="font-display text-lg font-bold text-forest-950">No candidates yet</h2>
          <p className="mx-auto mt-1 max-w-sm text-sm text-slate">
            Import your existing spreadsheet, or add candidates one at a time. Already searching? Try
